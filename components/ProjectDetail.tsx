  ...
  return (
    <div className="h-[100dvh] w-screen bg-[var(--color-paper)] overflow-hidden flex flex-col select-none font-sans">
      ...
      <header className="h-16 shrink-0 border-b border-[var(--color-paper-dark)]/20 px-6 flex items-center justify-between bg-[var(--color-paper)] z-50">
        ...
        {project.liveUrl && (
          <a href={project.liveUrl} target="_blank" rel="noreferrer" className="flex items-center gap-2 px-3 py-1.5 bg-[var(--color-ink)] text-white rounded-full shadow-lg hover:bg-[#D4FF00] hover:text-black active:scale-95 transition-all">
      ...
      <div className="flex-1 flex w-full relative overflow-hidden">
        ...
        <div 
          ...
          style={{ width: '40%' }}
        >
           {/* The "Frame" Container - Uses aspect-ratio to lock vertical orientation while filling height */}
